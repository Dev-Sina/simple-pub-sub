...
var order1 = new Order(1, 350000M, DateTime.UtcNow.AddDays(-3));
var order2 = new Order(2, 186000M, DateTime.UtcNow.AddDays(-2));
var order3 = new Order(3, 1030000M, DateTime.UtcNow.AddDays(-1));
...
var shipment1 = new Shipment(1L, 1, "1000100067843");
var shipment2 = new Shipment(2L, 1, "2000100099152");
var shipment3 = new Shipment(3L, 2, "3000200068853");
